...
import stmall.domain.StockDecreaed;
...
public class Inventory {
    ...
    public static void decreaseStock(DeliveryCompleted deliveryCompleted) {
        ...
        StockDecreaed stockDecreaed = new StockDecreaed(inventory);
        stockDecreaed.publishAfterCommit();
        */
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void increaseStock(DeliveryReterned deliveryReterned) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(deliveryReterned.get???()).ifPresent(inventory->{
