...
public class Order {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updataStatus(DeliveryReterned deliveryReterned) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(deliveryReterned.get???()).ifPresent(order->{
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updataStatus(DeliveryCompleted deliveryCompleted) {
        //implement business logic here:
